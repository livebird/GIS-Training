...
<header class="topbar">
  <div class="inner">
<?php if ($chapter): ?>
    <a class="home" href="<?= $ROOT ?>index.php" title="Course index">← Course</a>
    <a class="brand" href="index.php">GIS <?= h($phase['n']) ?> · <span>Chapter <?= $chapter['n'] ?></span></a>
...
<?php endforeach; ?>
      <a href="glossary.php" class="<?= $HERE === 'glossary.php' ? 'active' : '' ?>">Glossary</a>
    </nav>
<?php else: ?>
    <a class="brand" href="<?= $ROOT ?>index.php">GIS &amp; ArcGIS <span>Training</span></a>
    <nav class="modnav" aria-label="Phases">
<?php foreach ($PHASES as $ph): ?>
      <a href="<?= $ROOT ?>index.php#<?= h($ph['id']) ?>"><?= h($ph['n']) ?></a>
<?php endforeach; ?>
    </nav>
<?php endif; ?>
  </div>
