...
function pageInit() {
  ...
  const terms = [
    ...
    ["Code page / .cpg", "The character encoding declared for a .dbf’s text, read from the .cpg file or the dBASE header. Without a Unicode code page honoured by the reader, non-ASCII characters become ? or boxes."],
    ...
    ["Before/after snapshot", "The property list recorded before and after a conversion: schema, count, geometry type, CRS, extent, nulls, free-text and identifier samples, date/time samples, a hand statistic, three known records."],
    ...
    ["Table F7", "This chapter’s made-up practice data: six assets on the flat training grid with a leading-zero code, a null score, +05:30 timestamps and field names longer than ten characters. Not a real place."]
  ];
